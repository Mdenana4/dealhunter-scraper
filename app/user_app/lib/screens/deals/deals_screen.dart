...
// (apiKey, strKey) — apiKey is sent directly to the server; empty = All
const _categoryKeys = [
  ('',              'cat_all'),
...
// Source options: (code sent to API, string key) — ILIKE matched on server
const _sources = [
  (null,      'source_all'),
...
class _DealsScreenState extends ConsumerState<DealsScreen> {
  ...
  void _setCategory(String cat) {
    ...
    ref.read(dealsProvider.notifier).setCategory(cat.isEmpty ? null : cat);
  }
